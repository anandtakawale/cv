...
\section{Skills}
\cvline{Programming}{Python, Haskell, Java, R, C\#, Visual Basic, C, C++}
\cvline{Web}{XHTML, XML, JavaScript, jQuery, AJAX, RDF}
\cvline{Informatics}{Relational databases (SQL), Triple stores (SPARQL)}
\cvline{Tools}{GrADS}
...
\cvline{other}{
    ...
    \newline USU, UNC, NESCent, Duke, and UVA.
}
